...
# ao inves de usar filter, em alguns casos posso utlizar um for
pilotos_titulos = [(piloto['titulos']) for piloto in pilotos]
print(pilotos_titulos)

#pode ser adicionado condições
pilotos_titulos = [(piloto['titulos']) for piloto in pilotos if piloto['titulos'] > 1]
print(pilotos_titulos)